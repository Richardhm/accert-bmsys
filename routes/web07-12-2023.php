...
//            ->first()->valor;
    ...
    Route::get('/financeiro/coletivo/em_analise/{mes?}/{userId?}',"App\Http\Controllers\Admin\FinanceiroController@coletivoEmAnalise")->name('financeiro.coletivo.em_analise');
    ...
    Route::post('/financeiro/coletivo/select/mes',"App\Http\Controllers\Admin\FinanceiroController@financeiroMontarSelectColetivo")->name('financeiro.montar.mes.coletivo');
