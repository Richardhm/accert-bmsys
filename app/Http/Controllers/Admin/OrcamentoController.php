...
class OrcamentoController extends Controller
{
    ...
    public function index()
    {
         ...
         return "Para Realizar orçamento entre na pagina <a href='https://vivaz.bmsys.com.br/orcamento'>Orçamento</a>";
    ...
    public function criarPDFAmbulatorial(Request $request)
    {
        ...
        $pdf = Corretora::first();
            ...
            $linha02 = "Coparticipação Parcial: somente em Terapias. Valor de 50% do procedimento limitado ao teto de R$ 68,90.";
            $linha03 = $pdf->linha_03_individual;
            $consultas_eletivas     = 21.20;
            $consultas_de_urgencia  = 37.10;
            $exames_simples         = 10.60;
            $exames_complexos       = 79.50;
            $terapias               = 68.90;
    ...
    public function criarPDF(Request $request)
    {
        ...
        if($plano_id == 1) {
            ...
            if($administradora == 1 && $cidade == 1) {
                ...
                $linha03 = "Coparticipação Parcial: somente em Terapias. Valor de 50% do procedimento ao teto de R$ 62,42";
            } else if($administradora == 1 && $cidade == 2) {
                $linha01 = "No Plano Coletivo por Adesão é cobrado uma taxa mensal associativa de acordo com cada entidade (R$ 4,00)";
                $linha03 = "Coparticipação Parcial: somente em Terapias. Valor de 50% do procedimento ao teto de R$ 64,26";
            } else {
                $linha01 = $pdf->linha_01_coletivo;
                $linha03 = $pdf->linha_03_coletivo;
            }
            ...
            $linha02 = "Coparticipação Parcial: Terapias neurológicas Especiais 68,90. Demais Terapias 21,20.";
            $linha03 = $pdf->linha_03_individual;
            $consultas_eletivas     = 21.20;
            $consultas_de_urgencia  = 37.10;
            $exames_simples         = 10.60;
