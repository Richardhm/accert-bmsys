...
@section('content')
    ...
    <div class="modal fade" id="mudarDataCriacao" tabindex="-1" role="dialog" aria-labelledby=cadastrar_pessoa_fisica_formulario_modal_coletivo"mudarDataCriacaoLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
            <div class="modal-header">
