...
@section('content')
    ...
    <div class="d-flex w-100" style="margin:0;padding:0;height: 73vh;" id="main_body">
        ...
        <div class="d-flex" style="flex-basis:59%;flex-direction:column;height:100%;">
            ...
            <div class="d-flex my-1 ranking_classificacao" style="height:20%;background-color:green;">
                @foreach(collect($ranking_mes)->take(5) as $r)

                    <div class="small-box bg-info w-100 mb-0 mr-1 d-flex">
                        <div class="d-flex justify-content-between w-100">
                            <div class="text-white d-flex flex-wrap align-content-between ml-1 font-weight-bold w-50" style="height:70%;">
                                <span class="w-100">{{$loop->iteration}}º</span>
                                <span class="w-100" style="font-size:0.55em;">{{$r->usuario}}</span>
                            </div>
                            <div class="d-flex" style="width:50%;height:50%;justify-content: flex-end;">
