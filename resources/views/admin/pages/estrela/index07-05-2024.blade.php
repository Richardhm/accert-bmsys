        ...
        <div class="d-flex flex-column w-75 mx-auto">
                ...
                <table class="table w-100 table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="width:20%;">
                                <div style="background-color:white;border-radius:8px;width:96%;color:black;padding:3px;">
                                    {{$r->usuario}}
                                </div>
                            </td>
                            <td style="width:5.6%">
            ...
            <div class="d-flex w-100 py-2">
                <div class="d-flex align-items-center justify-content-between justify-content-end" style="width:50%;">
                    ...
                    <div class="d-flex flex-column text-white text-center" style="line-height:1;">
                ...
                <div class="d-flex align-items-center justify-content-end" style="width:50%;line-height:1;">
