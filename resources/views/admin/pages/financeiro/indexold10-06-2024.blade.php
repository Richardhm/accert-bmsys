        ...
        <main id="aba_individual">
            ...
            <section class="d-flex justify-content-between" style="flex-wrap: wrap;align-content: flex-start;">
                ...
                <div class="d-flex flex-column text-white" style="flex-basis:16%;border-radius:5px;">
                    ...
                    <div class="d-flex justify-content-between mb-1">
                        <span class="btn btn-upload" style="background-color:#123449;color:#FFF;font-size:1em;flex-basis:30%;">Upload</span>
                        <span class="btn btn-atualizar" style="background-color:#123449;color:#FFF;font-size:1em;flex-basis:30%;">Atualizar</span>
                        <span class="btn btn-cancelados" style="background-color:#123449;color:#FFF;font-size:1em;flex-basis:30%;">Cancelados</span>
                    </div>
